...
cpi_subset <- cpi_joined %>%
  ...
  mutate(
    product = case_when(
      ...
      product == "Fresh milk" ~ "Milk",
      product == "Fresh fruit" ~ "Fruit",
      product == "Fresh vegetables" ~ "Vegetables",
      product == "Food purchased from restaurants" ~ "Restaurant food",
      product == "Mortgage interest cost" ~ "Mortgage interest",
      product == "Fuel oil and other fuels" ~ "Fuel oil",
      product == "Homeowners' replacement cost" ~ "Home replacement cost",
      product == "Homeowners' home and mortgage insurance" ~ "Home and mortgage insurance",
      product == "Homeowners' maintenance and repairs" ~ "Home maintenance and repairs",
      ...
      product == "Passenger vehicle maintenance and repair services" ~ "Car maintenance and repair",
      ...
      product == "Computer equipment, software and supplies" ~ "Computer equipment",
